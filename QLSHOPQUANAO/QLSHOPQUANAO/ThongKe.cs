...
namespace QLSHOPQUANAO
{
    public partial class ThongKe : Form
    {
        ...
        SqlConnection conn = new SqlConnection("Data Source=DESKTOP-IKDLULL;Initial Catalog=SHOPQUANAO;Integrated Security=True");
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                dt = laybang("select distinct c.sohd, c.masanpham,h.manhanvien,h.ngaylap,h.makh,c.dongia,c.soluong,c.tongtien from hoadon h join CTHoadon c on h.sohd=c.sohd where c.sohd='" + combo.Text.Trim() + "'");
                ThongKeHD rp = new ThongKeHD();
                rp.SetDataSource(dt);
                crystalReportViewer1.ReportSource = rp;
            }
